...
-> Pas fait
- A partir de 2007, les ventes de moniteurs de diagonale supérieure à 20 pouces (50,8 cm) ont fortement augmenté, ces écrans sont principalement au format 16/10e, ou 16/9e, désormais très rarement au format 4/3, 21/9 ou 5/4.
Avant 2007, le format d'image 4/3 était prédominant pour une diagonale inférieure à 20 pouces.
Ce changement de format permet d'optimiser la découpe industrielle des dalles, afin de réduire les coûts de production.
Pour des raisons économiques et de rentabilité, le format des écrans d'ordinateur suit donc le format des télévisions.
...
## Résolution (:camera:)
Pas fait ->
À l’heure actuelle, il existe sept résolutions d’écrans standardisées. Elles se déclinent en HD (1366 x 768), HD+ (1600 x 900), Full HD (1920 x 1080), QHD (2560 x 1440), QHD+ (3200 x 1800) et 4K (3840 x 2160).

Les écrans HD sont généralement disponibles en taille 13 et 15,6 pouces. Ils sont parfaitement adaptés pour un usage courant (Internet, mail, vidéo, bureautique). Les Full HD sont disponibles sur quasiment tous les écrans LCD de 11 jusqu’à 17,3 pouces et vous permettent de visionner des vidéos en 1080p ou en 720p. Les QHD et QHD+ se retrouvent principalement sur les ultras portables avec des tailles d’écran allant de 12 à 13,3 pouces. Enfin, la résolution 4K, à titre de comparaison, propose quatre fois plus de détails que la Full HD. L’affichage est fin et les contours des objets sont lisses. Cette caractéristique de netteté, même en arrière-plan, est très appréciée par les gamers.
